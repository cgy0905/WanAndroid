...
interface SearchResultContract {
    ...
    interface View : IView{
        fun  requestAritilSucces(ariticles : ApiPagerResponse<MutableList<ArticleResponse>>)
    ...
    interface Model : IModel{
        fun getArilist(pageNo:Int,searchKey:String): Observable<ApiResponse<ApiPagerResponse<MutableList<ArticleResponse>>>>
